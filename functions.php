...
function emmabrownetherapy_scripts() {
	wp_enqueue_style( 'emmabrownetherapy-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'emmabrownetherapy-style', 'rtl', 'replace' );

	wp_enqueue_script( 'emmabrownetherapy-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
